...
public class MergeGroupPolicies extends WorkspaceAllocateTestScriptBase {
  ...
  protected void doUserJourney(TestUserSpecification testUser, WorkspaceApi workspaceApi)
    ...
    */
    ...
    /*
     Scenario 1: Group policy merging. WS(groupA) can merge DC(nogroup).
    */
    ...
    /*
     Scenario 2: Group policy merging. WS(groupA) can merge DC(groupA).
    */
    ...
    /*
     Scenario 3: Group policy merging. WS(groupA) cannot merge DC(groupB).
    */
    ...
    /*
     Scenario 4: Group policy merging. WS(nopolicy) cannot merge DC(groupB).
    */
