...
import static bio.terra.workspace.common.testfixtures.ReferenceResourceFixtures.makeGitRepoResource;
import static bio.terra.workspace.common.testfixtures.ReferenceResourceFixtures.makeReferencedBqDataTableResource;
import static bio.terra.workspace.common.testfixtures.ReferenceResourceFixtures.makeReferencedBqDatasetResource;
import static bio.terra.workspace.common.testfixtures.ReferenceResourceFixtures.makeReferencedGcsBucketResource;
import static bio.terra.workspace.common.testfixtures.ReferenceResourceFixtures.makeReferencedGcsObjectResource;
...
import static bio.terra.workspace.common.testutils.MockMvcUtils.REFERENCED_DATA_REPO_SNAPSHOTS_V1_PATH_FORMAT;
import static bio.terra.workspace.common.testutils.MockMvcUtils.REFERENCED_DATA_REPO_SNAPSHOT_V1_PATH_FORMAT;
import static bio.terra.workspace.common.testutils.MockMvcUtils.REFERENCED_GCP_BIG_QUERY_DATASETS_V1_PATH_FORMAT;
import static bio.terra.workspace.common.testutils.MockMvcUtils.REFERENCED_GCP_BIG_QUERY_DATASET_V1_PATH_FORMAT;
import static bio.terra.workspace.common.testutils.MockMvcUtils.REFERENCED_GCP_BIG_QUERY_DATA_TABLES_V1_PATH_FORMAT;
import static bio.terra.workspace.common.testutils.MockMvcUtils.REFERENCED_GCP_BIG_QUERY_DATA_TABLE_V1_PATH_FORMAT;
import static bio.terra.workspace.common.testutils.MockMvcUtils.REFERENCED_GCP_GCS_BUCKETS_V1_PATH_FORMAT;
import static bio.terra.workspace.common.testutils.MockMvcUtils.REFERENCED_GCP_GCS_OBJECTS_V1_PATH_FORMAT;
import static bio.terra.workspace.common.testutils.MockMvcUtils.REFERENCED_GIT_REPOS_V1_PATH_FORMAT;
import static bio.terra.workspace.common.testutils.MockMvcUtils.REFERENCED_GIT_REPO_V1_PATH_FORMAT;
