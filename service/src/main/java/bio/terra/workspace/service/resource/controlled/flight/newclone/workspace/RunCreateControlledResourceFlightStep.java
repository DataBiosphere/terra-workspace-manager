...
public class RunCreateControlledResourceFlightStep implements Step {
  ...
  public StepResult doStep(FlightContext context) throws InterruptedException, RetryException {
    ...
    ControlledResource resource =
        workingMap.get(
            WorkspaceFlightMapKeys.ControlledResourceKeys.DESTINATION_RESOURCE,
    ...
    if (!doesFlightExist(jobId)) {
      ...
      String rawParameters =
          workingMap.getRaw(WorkspaceFlightMapKeys.ControlledResourceKeys.RESOURCE_PARAMETERS);
      ...
      jobService
          ...
          .addParameterRaw(
              WorkspaceFlightMapKeys.ControlledResourceKeys.CREATION_PARAMETERS, rawParameters)
          .submit();
    }

    // TODO: PF-2107 the original clone code retries on an expired wait. Seems that a better
    // approach
