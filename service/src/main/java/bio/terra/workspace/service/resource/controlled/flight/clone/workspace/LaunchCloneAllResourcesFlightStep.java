...
public class LaunchCloneAllResourcesFlightStep implements Step {
  ...
  public StepResult doStep(FlightContext context) throws InterruptedException, RetryException {
    final var cloneAllResourcesFlightId = context.getInputParameters().get(ControlledResourceKeys.CLONE_ALL_RESOURCES_FLIGHT_ID, String.class);

    final List<ResourceWithFlightId> resourcesAndFlightIds = context.getWorkingMap()
