...
public enum WsmResourceType2 {
   ...
   */
  public static WsmResourceType2 fromSql(String dbString) {
    for (WsmResourceType2 value : values()) {
   ...
   */
  public static @Nullable WsmResourceType2 fromApiOptional(
