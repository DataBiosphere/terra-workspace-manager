...
public final class WorkspaceFlightMapKeys {
  ...
  public static class ControlledResourceKeys {
    ...
    public static final String SOURCE_CLONE_INPUTS = "sourceBucketCloneInputs";
    public static final String DESTINATION_CLONE_INPUTS = "destinationBucketCloneInputs";
