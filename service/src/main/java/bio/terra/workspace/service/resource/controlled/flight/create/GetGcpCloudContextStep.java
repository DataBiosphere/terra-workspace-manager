...
public class GetGcpCloudContextStep implements Step {
  ...
  public GetGcpCloudContextStep(UUID workspaceId, GcpCloudContextService gcpCloudContextService) {
  ...
  public StepResult doStep(FlightContext flightContext)
    ...
    GcpCloudContext context = gcpCloudContextService.getRequiredGcpCloudContext(workspaceId);
