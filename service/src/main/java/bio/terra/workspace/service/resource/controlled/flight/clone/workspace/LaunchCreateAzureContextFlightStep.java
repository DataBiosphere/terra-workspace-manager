...
public class LaunchCreateAzureContextFlightStep implements Step {

    private final WorkspaceService workspaceService;

    public LaunchCreateAzureContextFlightStep(WorkspaceService workspaceService) {
    ...
    public StepResult doStep(FlightContext context) throws InterruptedException, RetryException {
        ...
        var cloudContext = context.getInputParameters().get(ControlledResourceKeys.AZURE_CLOUD_CONTEXT, AzureCloudContext.class);
        ...
        if (!flightAlreadyExists) {
            workspaceService.createAzureCloudContext(destinationWorkspace, cloudContextJobId, userRequest, null, cloudContext);
        }
