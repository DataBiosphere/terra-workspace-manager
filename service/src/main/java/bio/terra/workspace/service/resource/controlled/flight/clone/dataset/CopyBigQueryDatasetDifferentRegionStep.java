...
public class CopyBigQueryDatasetDifferentRegionStep implements Step {
    public static final Logger logger = LoggerFactory.getLogger(CopyBigQueryDatasetDifferentRegionStep.class);
    ...
    public StepResult doStep(FlightContext flightContext)
        ...
        String destinationDatasetId = inputParameters.get(ControlledResourceKeys.DESTINATION_DATASET_NAME, String.class);
        ...
        try (DataTransferServiceClient dataTransferServiceClient = DataTransferServiceClient.create()) {
            ...
            DataTransferServiceClient.ListTransferRunsPagedResponse runs = dataTransferServiceClient.listTransferRuns(config.getName());
            ...
            for (TransferRun run : runs.iterateAll()) {
                ...
                while (true) {
                    ...
                    // Data transfer run has finished. It is either SUCCEEDED (4), FAILED (5), or CANCELLED (6)
