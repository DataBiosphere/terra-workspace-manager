...
import bio.terra.workspace.service.resource.controlled.cloud.aws.storageFolder.ControlledAwsStorageFolderHandler;
...
public enum WsmResourceType {
  ...
  CONTROLLED_AWS_STORAGE_FOLDER(
      CloudPlatform.AWS,
      StewardshipType.CONTROLLED,
      "CONTROLLED_AWS_STORAGE_FOLDER",
      ApiResourceType.AWS_STORAGE_FOLDER,
      ControlledAwsStorageFolderResource.class,
      ControlledAwsStorageFolderHandler::getHandler),
