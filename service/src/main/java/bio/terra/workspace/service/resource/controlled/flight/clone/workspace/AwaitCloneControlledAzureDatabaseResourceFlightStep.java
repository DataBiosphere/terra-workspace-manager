...
/**
 * Wait for the clone controlled database flight to complete and add the result to the appropriate map
 */
public class AwaitCloneControlledAzureDatabaseResourceFlightStep implements Step {
    ...
    public AwaitCloneControlledAzureDatabaseResourceFlightStep(ControlledAzureDatabaseResource resource, String subflightId) {
    ...
    public StepResult doStep(FlightContext context) throws InterruptedException, RetryException {
        try {
            ...
            FlightState subflightState = context.getStairway().waitForFlight(subflightId, FLIGHT_POLL_SECONDS, FLIGHT_POLL_CYCLES);
            ...
            context
                    .getWorkingMap()
                    .put(WorkspaceFlightMapKeys.ControlledResourceKeys.RESOURCE_ID_TO_CLONE_RESULT, resourceIdToResult);
        ...
        validateRequiredEntries(
                context.getWorkingMap(), WorkspaceFlightMapKeys.ControlledResourceKeys.RESOURCE_ID_TO_CLONE_RESULT);
