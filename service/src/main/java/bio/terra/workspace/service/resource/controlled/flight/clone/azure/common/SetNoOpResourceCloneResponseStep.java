...
public abstract class SetNoOpResourceCloneResponseStep<T extends ControlledResource> implements Step {
    private final T sourceResource;

    public SetNoOpResourceCloneResponseStep(
            T sourceResource) {
