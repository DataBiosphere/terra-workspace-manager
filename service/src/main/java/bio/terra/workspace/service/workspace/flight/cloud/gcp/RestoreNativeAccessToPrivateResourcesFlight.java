...
public class RestoreNativeAccessToPrivateResourcesFlight extends Flight {
   ...
   */
  public RestoreNativeAccessToPrivateResourcesFlight(FlightMap inputParameters, Object beanBag) {
    ...
    resource
        .getRestoreNativeAccessSteps(flightBeanBag)
