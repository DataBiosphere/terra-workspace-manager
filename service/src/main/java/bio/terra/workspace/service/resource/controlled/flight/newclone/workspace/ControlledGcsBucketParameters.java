...
/**
 * Mutable class for incrementally building and passing around GCS bucket parameters. These are
 * either going to be attributes or are set on the cloud resource, but not retained in the WSM
 * metadata
 */
public class ControlledGcsBucketParameters {
  ...
  public ControlledGcsBucketParameters setLifecycleRules(
