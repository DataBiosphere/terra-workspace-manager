...
/**
 * During workspace clone, we gather all of the metadata inputs needed for doing a workspace clone
...
public class CloneSourceMetadata {
  ...
  public void setResourcesByInstruction(
      Map<CloningInstructions, List<WsmResource>> resourcesByInstruction) {
