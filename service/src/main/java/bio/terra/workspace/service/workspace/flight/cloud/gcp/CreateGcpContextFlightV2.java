...
import bio.terra.workspace.service.workspace.flight.create.workspace.CheckSpendProfileStep;
...
public class CreateGcpContextFlightV2 extends Flight {
  ...
  public CreateGcpContextFlightV2(FlightMap inputParameters, Object applicationContext) {
    ...
    addStep(new CreateCustomGcpRolesStep(gcpCloudSyncRoleMapping, crl.getIamCow()), shortRetry);
