...
/**
 * This class wraps the Stairway flight class and provides additional features.
 * Some of these should probably move into Stairway, but for now...
 */
public class WsmFlight extends Flight {
    ...
    /**
     * Override addStep and make it public, so we can delegate step generation to subroutines
     * instead of having it all in the flight object. That allows more composable flights.
