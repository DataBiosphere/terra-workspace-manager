...
/**
 * During JUnit testing, when the application context gets refreshed the connection pools are abandoned.
 * As a result, we leak database connections. This class is a replacement for  DataSourceInitializer
 * This class tracks the object pools holding the connections and is able to close them.
 * It is a bean so can receive the PreDestroy call and do close at that time.
 *
 * TODO: If we like this solution, I will implement this in the common library
 */
@Component
