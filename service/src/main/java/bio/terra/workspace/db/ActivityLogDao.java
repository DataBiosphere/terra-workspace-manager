...
public class ActivityLogDao {
  ...
  @WriteTransaction
  public void writeActivity(UUID workspaceId, DbActivityLog dbActivityLog) {
    switch (dbActivityLog.getOperationType()) {
      case CLONE:
        // fall-through
      case UNKNOWN:
        return;
      ...
      case UPDATE:
        ...
        final var params =
            new MapSqlParameterSource()
                ...
                .addValue("change_type", dbActivityLog.getOperationType().name());
