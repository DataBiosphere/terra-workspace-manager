...
/**
 * Utility functions for translating between interface objects and internal objects. Generally, these
 * should only be called by Controllers, as services and other internal layers should not know about
 * interface objects.
 */
