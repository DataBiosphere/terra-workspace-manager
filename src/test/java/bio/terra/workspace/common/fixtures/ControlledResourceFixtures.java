...
public class ControlledResourceFixtures {
  ...
  public static final GoogleBucketLifecycleRule LIFECYCLE_RULE_1 = new GoogleBucketLifecycleRule()
      .action(
  ...
  public static final GoogleBucketLifecycleRule LIFECYCLE_RULE_2 = new GoogleBucketLifecycleRule()
      .action(
          new GoogleBucketLifecycleRuleAction()
  ...
  public static final String RESOURCE_DESCRIPTION = "A bucket that had beer in it, briefly. \uD83C\uDF7B";
