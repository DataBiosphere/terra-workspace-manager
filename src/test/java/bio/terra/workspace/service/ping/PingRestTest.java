...
//                 .andReturn();
//         MockHttpServletResponse response = result.getResponse();
//         ErrorReport errorReport = objectMapper.readValue(response.getContentAsString(),
// ErrorReport.class);
//         assertThat("Correct message text", errorReport.getMessage(), equalTo("No message to
// ping"));
//     }
// }
