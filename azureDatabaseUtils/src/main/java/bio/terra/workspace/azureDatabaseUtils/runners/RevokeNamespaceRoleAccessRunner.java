...
@Profile("RevokeNamespaceRoleAccess")
@Component
public class RevokeNamespaceRoleAccessRunner implements ApplicationRunner {
  @Value("${env.params.namespaceRole}")
  private String namespaceRole;

  private final DatabaseService databaseService;

  public RevokeNamespaceRoleAccessRunner(DatabaseService databaseService) {
